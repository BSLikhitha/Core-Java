class JobPortalExecuter
{
	public static void main(String[] args)
	{
		...
		JobPortal.getJobNames(Jobs);

		Company = "Naukri";
		Jobs = JobPortal.searchJobsByCompany(Company);
		JobPortal.getJobNames(Jobs);
